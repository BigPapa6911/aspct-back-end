...
namespace aspcts_backend.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<SessionProtocolData> SessionProtocolData { get; set; } = null!;
        public DbSet<ProtocolRecord> ProtocolRecords { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.ProtocolDataId);
            ...
            modelBuilder.Entity<ProtocolRecord>(entity =>
            {
                ...
                entity.HasOne(pr => pr.ProtocolData)
                    .WithMany(spd => spd.Records)
                    .HasForeignKey(pr => pr.ProtocolDataId)
                    .OnDelete(DeleteBehavior.Cascade);

                entity.HasIndex(pr => pr.ProtocolDataId)
                    .HasDatabaseName("IX_ProtocolRecords_ProtocolDataId");

                entity.HasIndex(pr => new { pr.ProtocolDataId, pr.Order })
            ...
            modelBuilder.Entity<TimeInterval>(entity =>
            {
                ...
                entity.HasOne(ti => ti.Record)
                    .WithMany(pr => pr.Intervals)
                    .HasForeignKey(ti => ti.RecordId)
                    .OnDelete(DeleteBehavior.Cascade);

                entity.HasIndex(ti => ti.RecordId)
                    .HasDatabaseName("IX_TimeIntervals_RecordId");

                entity.HasIndex(ti => new { ti.RecordId, ti.Minutes })
