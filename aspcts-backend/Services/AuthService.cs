    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResponse> RegisterAsync(RegisterRequest request)
        {
            ...
            if (request.Role == "Psychologist")
            {
                ...
                // Note: You'd need to inject a psychologist repository or use context directly
                // For simplicity, assuming this is handled elsewhere or using context directly
            }
            else if (request.Role == "Parent")
            {
                ...
                // Note: Same as above for parent repository
            }
