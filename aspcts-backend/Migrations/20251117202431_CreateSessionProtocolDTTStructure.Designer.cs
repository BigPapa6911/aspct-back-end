...
namespace aspcts_backend.Migrations
{
    ...
    [Migration("20251117202431_CreateSessionProtocolDTTStructure")]
    partial class CreateSessionProtocolDTTStructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aspcts_backend.Models.Entities.Report", b =>
                {
                    ...
                    b.HasIndex("StartPeriod", "EndPeriod")
            ...
            modelBuilder.Entity("aspcts_backend.Models.Entities.SessionProtocolData", b =>
                {
                    b.HasOne("aspcts_backend.Models.Entities.Report", "Report")
                        .WithMany("SessionsProtocolData")
                        .HasForeignKey("ReportId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("aspcts_backend.Models.Entities.Session", "Session")
                        .WithOne("ProtocolData")
                        .HasForeignKey("aspcts_backend.Models.Entities.SessionProtocolData", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("aspcts_backend.Models.Entities.Report", b =>
                {
                    b.Navigation("SessionsProtocolData");
                });
